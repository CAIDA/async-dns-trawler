...
class ScalarPredicateTestCase(unittest.TestCase):
    ...
    def test_hash_not_equal_different_datatype(self) -> None:
        predicate = ScalarPredicate(TEST_PREDICATE_NAME, TEST_INT_PREDICATE_VALUE, ScalarType.INT)
        predicate2 = ScalarPredicate(TEST_PREDICATE_NAME, TEST_INT_PREDICATE_VALUE_STR, ScalarType.STRING)
    ...
    def test_to_nquad_statement_string(self) -> None:
        predicate = ScalarPredicate(TEST_PREDICATE_NAME, TEST_INT_PREDICATE_VALUE_STR, ScalarType.STRING)
        self.assertEqual(predicate.to_nquad_statement(), TEST_STRING_PREDICATE_NQUAD_STATEMENT)
