...
# TEST_GET_RESPONSE_1 = '{"get":[{"TEST_ATTR_NAME":["TEST_ATTR_VALUE"]}]}'
# TEST_GET_RESPONSE_2 = '{"get":[{"TEST_ATTR_NAME_2":0}]}'
...
#         dgraph_client._client.txn = MockBuilder().returns_mock() \
#             .with_mock_attr("query").returns_mock() \
#             .with_attr('json', TEST_GET_RESPONSE_1) \
#             .build_all()
...
#         actual = dgraph_client.get(Node(TEST_NODE_ID))
...
#         dgraph_client._client.txn = MockBuilder().returns_mock() \
#             .with_mock_attr("query").returns_mock() \
#             .with_attr('json', TEST_GET_RESPONSE_2) \
#             .build_all()
...
#         dgraph_client._client.txn = MockBuilder().returns_mock() \
#             .with_mock_attr("query").returns_mock() \
#             .with_attr('json', TEST_EMPTY_GET_RESPONSE) \
#             .build_all()

#         def get_node() -> None:
#             dgraph_client.get(Node(TEST_NODE_ID))
...
#         dgraph_client._client.txn = MockBuilder().returns_mock() \
#             .with_mock_attr("query", side_effect=AbortedError()) \
#             .build_all()
